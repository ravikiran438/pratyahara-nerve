...
"""MCP server exposing NERVE safety-invariant validators.

Run with ``python -m nerve.mcp_server`` or via the ``nerve-mcp`` entry
...
from nerve.mcp_server.server import build_server, main
