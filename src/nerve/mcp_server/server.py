...
"""Main stdio MCP server for the NERVE reference implementation.
...
sauvidya-pace). When copying this file, change only:
  ...
  - the `from nerve.mcp_server.tools import ...` line
...
from nerve.mcp_server.tools import HANDLERS, TOOL_SCHEMAS, ToolInvocationError

SERVER_NAME = "nerve"
SERVER_VERSION = "0.1.0"
SERVER_INSTRUCTIONS = (
    "NERVE (Pratyahara, neural-defense integrity protocol) reference "
    "server. Exposes the seven named Core safety-invariant validators "
    "(dual coverage, asymmetric trust, severance finality, quarantine "
    "freeze, inhibitory gating, refractory, critical restriction) plus "
    "three Yathartha extension validators for capability-surface "
    "integrity (N-16 coverage-conditional drift, N-17 probe battery "
    "maintenance, N-18 capability surface integrity). All tools take "
...
def main() -> None:
    """Entry point for ``python -m nerve.mcp_server`` and the ``nerve-mcp`` script.
